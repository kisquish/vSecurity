...
insert into contribution (contributor_idPTCUserName, contribution_amount, contribution_created, contribution_updated) values ('1', 50, NOW(), NOW())

insert into ptcusername(ptcuser_name) values ('naymar')
insert into contribution (contributor_idPTCUserName, contribution_amount, contribution_created, contribution_updated) values ('2',25, NOW(), NOW())
insert into contribution (contributor_idPTCUserName, contribution_amount, contribution_created, contribution_updated) values ('2',75, NOW(), NOW())

insert into ptcusername(ptcuser_name) values ('dexter')
insert into contribution (contributor_idPTCUserName, contribution_amount, contribution_created, contribution_updated) values ('3',45, NOW(), NOW())
insert into contribution (contributor_idPTCUserName, contribution_amount, contribution_created, contribution_updated) values ('3',100, NOW(), NOW())

insert into ptcusername_contribution (ptcusername_idPTCUserName,contribution_idContribution) values (1, 1)
insert into ptcusername_contribution (ptcusername_idPTCUserName,contribution_idContribution) values (1, 2)

insert into ptcusername_contribution (ptcusername_idPTCUserName,contribution_idContribution) values (2, 3)
insert into ptcusername_contribution (ptcusername_idPTCUserName,contribution_idContribution) values (2, 4)

insert into ptcusername_contribution (ptcusername_idPTCUserName,contribution_idContribution) values (3, 5)
insert into ptcusername_contribution (ptcusername_idPTCUserName,contribution_idContribution) values (3, 6)

--Thu Jun 01 22:02:19 CEST 2017
